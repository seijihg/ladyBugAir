...
const urlAirports =
  "https://pubapi.atadi.vn/air/test/getresourcebykey/air_originlist";
...
exports.getLogo = iata => {
  return axios({
    url: `https://services.daisycon.com/airline?iata=${iata}`,
    headers: {
      Authorization: "Basic " + btoa(process.env.LOGO),
      "Content-Type": "application/json"
    }
  });
};
